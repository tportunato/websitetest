...
| About / Vision / Sustainability / Investment profile | REAL (qualitative) | Written for these pages in DAA house voice. NO fund-level figures: no fund size, target return, market count or third-party market statistic. The only numbers are the EUR 5m-50m mandate band, already published by DAA, and Heyrieux's BREEAM "Very Good" from DAA's own press release. |
